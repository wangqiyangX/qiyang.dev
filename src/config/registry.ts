export const registryConfig = {
   ...
   * @example "@qiyangdev" - Users can install components with: `npx shadcn add @qiyangdev/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@qiyangdev",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://qiyang.dev/r/{name}.json" resolves to "https://qiyang.dev/r/wheel-picker.json"
