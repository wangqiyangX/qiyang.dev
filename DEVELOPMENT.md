...
```bash
git clone https://github.com/qiyangdev/qiyang.dev.git qiyang.dev
cd qiyang.dev
```
...
The application should now be available at https://qiyang.localhost
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [qiyang.dev/components](https://qiyang.dev/components) for installation instructions and component documentation.
